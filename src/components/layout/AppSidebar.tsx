...
import { BarChart3, Leaf, User, Users, CookingPot } from "lucide-react";
...
export default function AppSidebar() {
  ...
  const profileLabel =
    [profile.nome, profile.sobrenome].filter(Boolean).join(" ").trim() ||
    "Nutricionista";
        ...
        <div className="flex h-16 items-center border-b border-border-subtle">
          <div className="flex h-full w-20 shrink-0 items-center justify-center">
            <button
              ...
              aria-label={
                isExpanded ? "Fechar menu lateral" : "Abrir menu lateral"
              }

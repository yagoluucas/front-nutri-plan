...
const textareaClasses =
  "w-full min-h-28 rounded-lg border border-border-default bg-surface-default p-4 text-body-default text-content-primary placeholder:text-content-placeholder shadow-sm transition-all resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-action-primary-focus";
const selectClasses =
  "w-full h-11 rounded-lg border border-border-default bg-surface-default px-4 text-body-default text-content-primary shadow-sm appearance-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-action-primary-focus transition-all";
...
export default function PatientForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      dataEntregaPrimeiroPlano: defaultValues?.dataEntregaPrimeiroPlano || "",
  ...
  return (
    <form
      ...
      className="rounded-lg border border-border-default bg-surface-default p-6 shadow-sm"
    >
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          {errors.sexo?.message && (
            <span className="text-caption text-feedback-error-text">
              {errors.sexo.message}
            </span>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register("dataEntregaPrimeiroPlano")}
            error={errors.dataEntregaPrimeiroPlano?.message}
          />
        </div>
